...
public class StringUtilities {
    ...
    public static String getFirstWord(String spaceDelimitedString){
        ...
        int i = 0;
        String result = String.valueOf(spaceDelimitedString.charAt(i));
        i++;

        while (spaceDelimitedString.charAt(i) != ' ')
        {
            result += String.valueOf(spaceDelimitedString.charAt(i));
            i++;
        }
    ...
    public static String getSecondWord(String spaceDelimitedString){
        ...
        return spaceDelimitedString.substring((i+1), (spaceDelimitedString.length()));
    }
